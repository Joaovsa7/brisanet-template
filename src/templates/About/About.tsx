		...
		<main className="py-8">
			<Container size="lg">
				...
				<Text className="max-w-full">
					...
					<p>
						Descubra conosco um mundo de possibilidades e economia! No Portal
						das Operadoras, nós te guiamos na jornada para encontrar os planos
						de saúde e telecomunicação mais vantajosos do mercado. Com nossa
						ajuda, escolher um plano que se encaixa perfeitamente em seu
						orçamento e necessidades é mais fácil do que nunca.
					</p>
					...
					<ul>
						...
						<li>
							<strong>Informação Atualizada:</strong> Fique por dentro das
							últimas novidades e oportunidades do mercado.
						</li>
					</ul>

					<h2>Venha Conosco!</h2>
					<p>
						Faça parte da nossa comunidade. Aqui no Portal das Operadoras,
						estamos sempre prontos para ajudá-lo a encontrar o melhor plano,
						economizando seu tempo e seu dinheiro. Explore conosco um mundo de
						possibilidades!
					</p>
				</Text>
			</Container>
